---
title: DOMTRIK — проектная память
date: 2026-08-15
tags:
  - domtrik
  - knowledge/index
...
- [[knowledge/CURRENT|Текущее состояние]]
...
- [[knowledge/sessions/2026-08-16-1104-admin-localization|Русификация и брендинг админки]]
- [[knowledge/sessions/2026-08-16-1118-admin-image-previews|Крупные миниатюры изображений в админке]]
- [[knowledge/sessions/2026-08-16-1132-disable-next-dev-indicator|Отключение индикатора Next.js]]
...
- `knowledge/inbox/` — необработанные заметки.
- `knowledge/attachments/` — вложения Obsidian.
- `knowledge/templates/` — шаблоны заметок.
